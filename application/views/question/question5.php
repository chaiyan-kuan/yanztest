...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-xl-9" style=" margin:auto; padding:15px ; height : 0px;">
                      ...
                      <?php echo form_open_multipart('index.php/products_control/actionquestion5'); ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height: auto; width: 600px;margin-left: -70px">
                               <div class="modal-header">
                                  <h3><span class="badge badge-pill badge-light" style="font-family:'EucrosiaUPC';font-size: 35px">5.เวลาใช้งานคอมพิวเตอร์ต่อวันโดยเฉลี่ย</span></h3>
                              </div>
                     ...
                     <div class="funkyradio">
                      ...
                      <input type="radio"  name="time" value="1" id="radio1">
                      <label for="radio1">1-4 ชั่วโมง<br></label>
                      </div>
                       <div class="funkyradio-success">
                      <input type="radio"  name="time" value="2" id="radio2">
                      <label for="radio2">5-9 ชั่วโมง<br></label>
                      </div>
                         <div class="funkyradio-success">
                      <input type="radio"  name="time" value="3" id="radio3">
                      <label for="radio3">10-15 ชั่วโมง<br></label>
                        </div>
                        <div class="funkyradio-success">
                      <input type="radio"  name="time" value="4" id="radio4">
                      <label for="radio4">15 ชั่วโมงขึ้นไป<br></label>
                        </div>
