...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-xl-9" style=" margin:auto; padding:15px ; height : 0px;">
                      ...
                      <?php echo form_open_multipart('index.php/products_control/actionquestion7'); ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height: auto; width: 600px;margin-left: -70px">
                               <div class="modal-header">
                                  <h3><span class="badge badge-pill badge-light" style="font-family:'EucrosiaUPC';font-size: 35px">7.คุณต้องการใช้ไวไฟ(WI-FI)หรือไม่</span></h3>
                              </div>
                      ...
                      <input type="radio"  name="wifi" value="1" id="radio1">
                      <label for="radio1">ใช่<br></label>
                      </div>
                       <div class="funkyradio-success">
                      <input type="radio"  name="wifi" value="2" id="radio2">
                      ...
                      <br>
                      <center><button type="submit" class="btn btn-outline-success" value = "Submit">Result</button></center>
                      <br>
