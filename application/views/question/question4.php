...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-xl-9" style=" margin:auto; padding:15px ; height : 0px;">
                      ...
                      <?php echo form_open_multipart('index.php/products_control/actionquestion4'); ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height: auto; width: 600px;margin-left: -70px">
                               <div class="modal-header">
                                  <h3><span class="badge badge-pill badge-light" style="font-family:'EucrosiaUPC';font-size: 28px">4.คาดว่าใช้งานในห้องแอร์หรือไม่(คิดจากเวลาที่ใช้งาน)</span></h3>
                      ...
                      <input type="radio"  name="air" value="1" id="radio1">
                      <label for="radio1">ใช่<br></label>
                      </div>
                       <div class="funkyradio-success">
                      <input type="radio"  name="air" value="2" id="radio2">
                      <label for="radio2">ไม่<br></label>
                      </div>
                         <div class="funkyradio-success">
                      <input type="radio"  name="air" value="3" id="radio3">
                      <label for="radio3">ใช้งานเท่าๆกัน<br></label>
                        </div>
                      </div>
