...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-xl-9" style=" margin:auto; padding:15px ; height : 0px;">
                      ...
                      <?php echo form_open_multipart('index.php/products_control/actionquestion3_2'); ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height: auto; width: 600px;margin-left: -70px">
                               <div class="modal-header">
                                  <h3><span class="badge badge-pill badge-light" style="font-family:'EucrosiaUPC';font-size: 30px">3.1 ประเภทงานมัลติมีเดียที่ใช้งาน(เลือกที่ใช้มากที่สุด)</span></h3>
                              </div>
                      ...
                      <input type="radio"  name="multi" value="1" id="radio1">
                      <label for="radio1">งานกราฟฟิค/3D<br></label>
                      </div>
                       <div class="funkyradio-success">
                      <input type="radio"  name="multi" value="2" id="radio2">
                      <label for="radio2">งานตัดต่อวิดีโอ<br></label>
                      </div>
                         <div class="funkyradio-success">
                      <input type="radio"  name="multi" value="3" id="radio3">
                      <label for="radio3">งานปรับแต่งภาพนิ่ง<br></label>
                        </div>
                      </div>
