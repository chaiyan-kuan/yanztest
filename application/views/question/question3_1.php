  ...
  <body>
    ...
    <div class="sticky-top"><nav class="navbar navbar-expand-lg navbar-light bg-light">
     ...
     <div class="col-xl-9" style=" margin:auto; padding:15px ; height : 0px;">
                      ...
                      <?php echo form_open_multipart('index.php/products_control/actionquestion3_1'); ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height: auto; width: 600px;margin-left: -70px">
                               <div class="modal-header">
                                  <h3><span class="badge badge-pill badge-light" style="font-family:'EucrosiaUPC';font-size: 35px">3.1 ผู้ใช้เล่นเกมประเภทใด (เลือกที่เล่นมากที่สุด)</span></h3>
                              </div>
                      ...
                      <input type="radio"  name="game" value="1" id="radio1">
                      <label for="radio1">AAA Grade Games<br></label>
                      </div>
                       <div class="funkyradio-success">
                      <input type="radio"  name="game" value="2" id="radio2">
                      <label for="radio2">Online MMORPG<br></label>
                      </div>
                         <div class="funkyradio-success">
                      <input type="radio"  name="game" value="3" id="radio3">
                      <label for="radio3">Casual Game<br></label>
                        </div>
                        <div class="funkyradio-success">
                      <input type="radio"  name="game" value="4" id="radio4">
                      <label for="radio4">Shooting<br></label>
                        </div>
