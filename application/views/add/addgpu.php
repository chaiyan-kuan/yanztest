  ...
  <div class="row">
    <div class="col-xl-9" style="background-color: white ; margin:auto; padding:15px ; height : auto;">
    	<center>
        	...
        	<?php echo form_open_multipart('index.php/products_control/actionaddgpu', 'class="email" id="myform"'); ?>
          <fieldset>
            <legend>Add Product GPU</legend>
              ...
              <input type="text" style = "width : 100%;" name="powerusage" class="form-control" id="powerusage" placeholder="Power Usage" required value="<?=set_value('powerusage')?>">
            ...
            <a class = "btn btn-outline-info" href="<?php echo base_url(); ?>index.php/products_control/showgpu">Back</a>
          </fieldset>
