  ...
  <div class="row">
    <div class="col-xl-9" style="background-color: white ; margin:auto; padding:15px ; height : auto;">
    	<center>
        	...
        	<?php echo form_open_multipart('index.php/products_control/actionaddhdd', 'class="email" id="myform"'); ?>
          <fieldset>
            <legend>Add Product HDD</legend>
            ...
            <a class = "btn btn-outline-info" href="<?php echo base_url(); ?>index.php/products_control/showhdd">Back</a>
          </fieldset>
