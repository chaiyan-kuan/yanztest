    ...
    <div class="col-xl-9" style="background-color: white ; margin:auto; padding:15px ; height : auto;">
          ...
          <ul class="pagination1">
           <li class="page-item"><a class = "page-link" href="<?php echo base_url(); ?>index.php/products_control/showcpu/<?php ?>">CPU</a></li>       
            ...
            <li class="page-item"><a class = "page-link" href="<?php echo base_url(); ?>index.php/products_control/showram/<?php ?>">RAM</a></li>
...
<div class="table-responsive">
    <table class="table table-hover table-dark" border ="1">
     ...
     <tr>
         ...
         <td><center><a class = "btn btn-outline-info" href="<?php echo base_url(); ?>index.php/products_control/editcooler/<?php echo $post['id']; ?>">Edit</a></td>
         <td><center><a class = "btn btn-danger" href="<?php echo base_url(); ?>index.php/products_control/deletecooler/<?php echo $post['id']; ?>">Delete</a></td>

    <?php }?>

  </td>
</table></div></div>
<?php echo form_open('index.php/request/logout', 'class="email" id="myform"'); ?>
