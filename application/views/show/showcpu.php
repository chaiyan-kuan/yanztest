...
<div class="table-responsive">
    <table class="table table-hover table-dark" border ="1">
     ...
     <tr>
         ...
         <td><center><a class = "btn btn-outline-info" href="<?php echo base_url(); ?>index.php/products_control/editcpu/<?php echo $post['id']; ?>">Edit</a></td>
         <td><center><a class = "btn btn-danger" href="<?php echo base_url(); ?>index.php/products_control/deletecpu/<?php echo $post['id']; ?>">Delete</a></td>
