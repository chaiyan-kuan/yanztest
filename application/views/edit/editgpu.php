...
<?php echo form_open_multipart('index.php/products_control/updategpu'); ?>
<center> <?php echo validation_errors();
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Maximum Power Usage</label>
    <input type="text" class="form-control" placeholder="powerusage" value = "<?php echo $post['powerusage'];?>" name = "powerusage">
